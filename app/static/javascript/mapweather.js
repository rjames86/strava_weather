...
(function() {
  var Footer, Form, InfoAboutSite, Main, Map, RouteInfo, UNITS, UnitsOption, d, savedPoints;
  ...
  Map = React.createFactory(React.createClass({
    ...
    makeInfoWindow: function(point, info) {
      ...
      toRet += listItem('Current Distance', (this.humanDistance(point).toFixed(2)) + " " + (this.unitsHuman()));
      toRet += '</dl>';
      return toRet;
    },
  ...
  InfoAboutSite = React.createFactory(React.createClass({
    messageText: function() {
      return ["Welcome! This is still in beta, so everything may not work. If you're here, I assume you know how to contact me. Please let me know if something breaks.", "Everything you see should be hooked up.", "- RideWithGPS routes and trips are supported right now.", "- Search may be slow. If you hit submit, it's searching. I don't have a loader indicator yet", "- If you change the date, speed or units, you'll have to click on the point again to get updated info"];
    },
    render: function() {
      var index, t;
      return d.div({
